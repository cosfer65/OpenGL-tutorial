...
public:
    ...
    virtual int init_game() {
        ...
        m_shader->add_file(GL_VERTEX_SHADER, "resources/cubemap_vs.hlsl");
        m_shader->add_file(GL_FRAGMENT_SHADER, "resources/cubemap_fs.hlsl");
        m_shader->load();

        m_sphere = new cg_gl_sphere(2);
