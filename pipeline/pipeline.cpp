...
// remove comment from the next line to enable tesselation
#define _USE_TESSELATION

#ifndef _USE_TESSELATION
...
const GLchar* frag_sh = { "#version 420 core\n"
"out vec4 color;\n"
"in vec4 es_color;\n"
"void main(void)\n"
"{\n"
...
void frame_render()
{
    ...
    mat4 model = translation_matrix(0, 0, -2);
